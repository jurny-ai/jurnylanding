        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex justify-center mb-8">
            <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-gradient-primary/10 border border-primary/20 backdrop-blur-sm">
              ...
              <span className="text-sm font-medium text-primary">Backed by Unusual Ventures</span>
            </div>
          </div>
          ...
          {/* Subheadline */}
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 leading-relaxed text-center">Define targeted personas and simulate real behavior at scale across critical user journeys</p>
