...
const Results = () => {
  return (
    <section id="results" className="bg-background py-6">
          ...
          {proofCards.map((card) => {
            ...
            if (!card.quote) {
              return (
                <div
                  key={card.title}
                  className="flex min-h-[280px] flex-col justify-center rounded-2xl border border-primary/20 bg-[linear-gradient(145deg,hsl(var(--secondary))_0%,rgba(117,88,232,0.10)_100%)] p-5 text-left shadow-[0_18px_52px_rgba(117,88,232,0.08)] sm:rounded-3xl sm:p-6"
                >
            ...
            return (
              <div
                key={card.title}
                className="grid min-h-[280px] rounded-2xl border border-primary/20 bg-[linear-gradient(145deg,rgba(117,88,232,0.12)_0%,hsl(var(--secondary))_55%,rgba(85,119,230,0.08)_100%)] p-5 text-left shadow-[0_18px_52px_rgba(117,88,232,0.1)] sm:rounded-3xl sm:p-6 xl:grid-cols-[1fr_auto_0.72fr] xl:items-center xl:gap-6"
              >
                <div>
