...
const SEGMENTS: Segment[] = [
  ...
  },
  {
    ...
    kind: "funnel",
    question: "Why do subscribers cancel after their first order?",
    moreQuestions: ["Where does replenishment lose buyers?", "Which offer creates confusion?"],
    personas: ["First-time subscriber", "Loyal customer", "Deal seeker"],
    dropStep: "Plan selection",
    dropOffs: [
      { segment: "First-time subscriber", loss: 44, worst: true },
      { segment: "Deal seeker", loss: 15 },
      { segment: "Loyal customer", loss: 9 },
    ],
  },
];
