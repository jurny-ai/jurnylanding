          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              ...
              <Card className="p-4 bg-muted/20 border">
                ...
                <p className="text-xs text-muted-foreground">I see a product comparison matrix with a lot of information. It is organized poorly and is hard to analyze quickly.</p>
              </Card>
