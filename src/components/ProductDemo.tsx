          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="p-8 rounded-3xl bg-[#1a1b26] border border-white/5 shadow-2xl space-y-6 transition-all duration-300 hover:border-primary/20">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="text-base font-bold text-white">Persona Creation</div>
                  <div className="text-xs text-white/40 uppercase tracking-widest">Step 01</div>
                </div>
              </div>
              ...
              <div className="p-6 rounded-2xl bg-white/5 border border-white/5 space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-base font-bold text-white">Jen, 28</div>
                </div>
            ...
            <div className="p-8 rounded-3xl bg-[#1a1b26] border border-white/5 shadow-2xl space-y-6 transition-all duration-300 hover:border-primary/20">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="text-base font-bold text-white">Real-time Simulation</div>
                  <div className="text-xs text-white/40 uppercase tracking-widest">Step 02</div>
                </div>
              </div>
              ...
              <div className="space-y-3">
                <div className="p-4 rounded-xl bg-white/5 border-l-2 border-primary-glow space-y-2">
                  <div className="flex justify-between items-center">
                    <span className="text-xs font-bold text-white">Action 11</span>
                    <span className="text-[11px] text-white/40">Product Page</span>
                  </div>
                  <p className="text-xs text-white/60 font-light">Click comparison matrix...</p>
                </div>
                <div className="p-4 rounded-xl bg-white/5 border-l-2 border-indigo-400 space-y-2">
                  <div className="flex justify-between items-center">
                    <span className="text-xs font-bold text-white text-indigo-400">Action 12</span>
                    <span className="text-[11px] text-white/40">In-progress</span>
                  </div>
                  <p className="text-xs text-white/60 font-light">Scroll to find actual review text</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-8 rounded-3xl bg-[#1a1b26] border border-white/5 shadow-2xl space-y-6 transition-all duration-300 hover:border-primary/20">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="text-base font-bold text-white">Actionable Insights</div>
                  <div className="text-xs text-white/40 uppercase tracking-widest">Step 03</div>
                </div>
              </div>
              ...
              <div className="p-6 rounded-2xl bg-primary/10 border border-primary/20 space-y-4">
                ...
                <div className="flex flex-col gap-3">
                  <div className="flex items-center text-xs font-bold text-white group cursor-pointer w-fit">
