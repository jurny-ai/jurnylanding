...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "The Biggest Problems With Usability Testing Today",
    description:
      "Usability testing is universally respected and routinely underused. Learn the five biggest problems and how autonomous usability testing solves them.",
    type: "article",
  },
...
export default function UsabilityTestingPage() {
  return (
    <BlogLayout
      title="The Biggest Problems With Usability Testing Today"
      subtitle="Usability testing is universally respected and routinely underused."
    ...
    >
      ...
      <section className="rounded-2xl bg-secondary/50 border border-border p-6 md:p-8">
        ...
        <p className="text-foreground/90 leading-relaxed mb-4">By the time issues are discovered:</p>
